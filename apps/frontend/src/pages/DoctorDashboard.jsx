...
import { createAppointment, fetchAppointments } from "../api/auth";
  ...
  return (
    <div>
        ...
        <div className="admin__container">
            ...
            <ReusableTable appointments={appointments} loggedInUser={location.state} handlePageChange={handlePageChange} pagination={pagination} setAppointments={setAppointments}/>
        </div>
    </div>
  );
};
